...
from ._exceptions import AkiraError, APIStatusError
...
if TYPE_CHECKING:
    from .resources import sandboxes, snapshots
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Akira", "AsyncAkira", "Client", "AsyncClient"]


class Akira(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Akira client instance.

        This automatically infers the `api_key` argument from the `AKIRA_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("AKIRA_API_KEY")
        if api_key is None:
            raise AkiraError(
                "The api_key client option must be set either by passing api_key to the client or by setting the AKIRA_API_KEY environment variable"
            )
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("AKIRA_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> AkiraWithRawResponse:
        return AkiraWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AkiraWithStreamedResponse:
        return AkiraWithStreamedResponse(self)
...
class AsyncAkira(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncAkira client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncAkiraWithRawResponse:
        return AsyncAkiraWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncAkiraWithStreamedResponse:
        return AsyncAkiraWithStreamedResponse(self)
...
class AkiraWithRawResponse:
    _client: Akira

    def __init__(self, client: Akira) -> None:
        self._client = client
...
class AsyncAkiraWithRawResponse:
    _client: AsyncAkira

    def __init__(self, client: AsyncAkira) -> None:
        self._client = client
...
class AkiraWithStreamedResponse:
    _client: Akira
...
class AsyncAkiraWithStreamedResponse:
    _client: AsyncAkira
